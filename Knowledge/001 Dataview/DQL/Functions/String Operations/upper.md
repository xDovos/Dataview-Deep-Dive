...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "upper", "Status Tasks")`
...
- docs:: [Function upper](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#upperstring)
