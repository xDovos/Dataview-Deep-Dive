...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "replace", "Status Tasks")`
...
- docs:: [Function replace](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#replacestring-pattern-replacement)
