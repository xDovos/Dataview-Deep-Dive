...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "split", "Status Tasks")`
...
- docs:: [Function split](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#splitstring-delimiter-limit)
