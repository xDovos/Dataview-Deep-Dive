...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "substring", "Status Tasks")`
...
- docs:: [Function substring](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#substringstring-start-end)
