...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "truncate", "Status Tasks")`

###### Status Tasks
- [x] Create the Note ✅ 2023-10-21
- [x] Write the YAML metadata ✅ 2023-11-04
- [x] add the docs page ✅ 2023-11-04
- [ ] Write the query


# truncate

- docs:: [Function truncate](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#truncatestring-length-suffix)
