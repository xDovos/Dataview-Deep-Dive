...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "padleft", "Status Tasks")`
...
- docs:: [Function padleft](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#padleftstring-length-padding)
