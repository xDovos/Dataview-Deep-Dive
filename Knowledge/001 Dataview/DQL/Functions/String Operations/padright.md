...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "padright", "Status Tasks")`
...
- docs:: [Function padright](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#padrightstring-length-padding)
