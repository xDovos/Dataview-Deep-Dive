...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "startswith", "Status Tasks")`
...
- docs:: [Function startswith](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#startswithstring-prefix)
