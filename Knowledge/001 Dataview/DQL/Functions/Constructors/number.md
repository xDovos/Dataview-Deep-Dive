...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "number", "Status Tasks")`
...
- docs:: [Function number](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#numberstring)
