...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "string", "Status Tasks")`
...
- docs:: [Function string](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#stringany)
