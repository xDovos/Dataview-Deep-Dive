...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "dur", "Status Tasks")`
...
- docs:: [Function dur](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#durany)
