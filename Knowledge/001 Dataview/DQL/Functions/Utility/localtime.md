...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "localtime", "Status Tasks")`
...
- docs:: [Function localtime](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#localtimedate)
