...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "meta", "Status Tasks")`
...
- docs:: [Function meta](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#metalink)
