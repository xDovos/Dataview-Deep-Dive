...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "default", "Status Tasks")`
...
- docs:: [Function default](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#defaultfield-value)
