...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "min", "Status Tasks")`
...
- docs:: [Function min](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#mina-b)
