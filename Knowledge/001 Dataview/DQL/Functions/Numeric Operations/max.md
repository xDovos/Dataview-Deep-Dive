...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "max", "Status Tasks")`
...
- docs:: [Function max](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#maxa-b)
