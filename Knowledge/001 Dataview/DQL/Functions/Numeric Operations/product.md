...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "product", "Status Tasks")`
...
- docs:: [Function product](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#productarray)
