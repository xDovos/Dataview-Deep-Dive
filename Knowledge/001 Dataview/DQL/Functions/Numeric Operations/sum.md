...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "sum", "Status Tasks")`
...
- docs:: [Function sum](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#sumarray)
