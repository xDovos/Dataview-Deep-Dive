...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "trunc", "Status Tasks")`
...
- docs:: [Function trunc](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#truncnumber)
