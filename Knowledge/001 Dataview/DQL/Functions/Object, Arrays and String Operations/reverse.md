...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "reverse", "Status Tasks")`
...
- docs:: [Function reverse](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#reverselist)
