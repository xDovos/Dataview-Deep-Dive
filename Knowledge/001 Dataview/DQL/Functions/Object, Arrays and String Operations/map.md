...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "map", "Status Tasks")`
...
- docs:: [Function map](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#maparray-func)
