...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "sort", "Status Tasks")`
...
- docs:: [Function sort](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#sortlist)
