...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "all", "Status Tasks")`
...
- docs:: [Function all](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#allarray)
