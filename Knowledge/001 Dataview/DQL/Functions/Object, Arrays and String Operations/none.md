...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "none", "Status Tasks")`
...
- docs:: [Function none](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#nonearray)
