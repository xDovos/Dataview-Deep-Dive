...
status:: `$=return(await self.require.import("Code Modules/modulePB.js.md")).PBSingleNoteHeader(dv, "extract", "Status Tasks")`
...
- docs:: [Function extract](https://blacksmithgu.github.io/obsidian-dataview/reference/functions/#extractobject-key1-key2)
